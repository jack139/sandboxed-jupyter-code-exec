    ...
    async def execute_code(self, code):
        ...
        while True:
            try:
                ...
                if msg_type == 'stream':
                    outputs.append(('text', content['text']))
                elif msg_type == 'execute_result':
                    outputs.append(('text', str(content['data'].get('text/plain', ''))))
                elif msg_type == 'display_data':
                    #if "text/plain" in content['data']:
                    #    outputs.append(('text', str(content['data']['text/plain'])))
                    if "image/png" in content['data']:
                        outputs.append(('image', str(content['data']['image/png'])))
                elif msg_type == 'error':
